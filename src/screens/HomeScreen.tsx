...
export const HomeScreen: React.FC = () => {
  ...
  return (
    <div className="home-screen">
      {/* Left-Side Demo Venue Navigation Rail */}
      <VenueSwitcher
        mode="rail"
      ...
      {/* Main Directory Content Pane */}
      <div className="home-directory-pane">
          ...
          <div className="home-venue-identity">
            <div className="venue-title-group">
              ...
              <div className="venue-hero-text">
                ...
                <span className="brand-venue-subtitle">{currentVenue.category} • Interactive 3D Wayfinding</span>
              </div>
            </div>
          </div>

          {/* Row 3: Search & A-Z Buttons */}
